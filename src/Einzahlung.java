public class Einzahlung extends Main {
    ...
    private static boolean istBetragGueltig(int betrag) {
        ...
        if (betrag < 5) {
            System.err.println("Fehler: Der Mindestbetrag für eine Einzahlung beträgt 5 Euro!");
            return false;
        }
        
        if (betrag % 5 != 0) {
            System.err.println("Fehler: Der Betrag " + betrag + " ist nicht durch 5 teilbar. Keine Einzahlung möglich!");
            return false;
        }
